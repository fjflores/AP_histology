...
allenPath = 'D:\Dropbox (MIT)\Protocols\Histology\AllenCCF';
...
%% Plot the endpoints of all probes
...
miceList = {...
    ...
    'M076', 'M077', 'M078',...
    'M079', 'M080', 'M085' };
allPoints = gatherpoints( miceList );

kind = 'lines';
nMice = length( allPoints );
